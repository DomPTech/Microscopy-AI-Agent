...
from app.services.asyncroscopy.protocols.utils import package_message, unpackage_message

try:
    import autoscript_tem_microscope_client as auto_script
except ImportError:
    auto_script = None
    print("Warning: autoscript_tem_microscope_client not found. Server will start but connection to microscope will fail.")
