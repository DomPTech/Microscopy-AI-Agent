...
import numpy as np
import Pyro5.api
from app.services.smart_proxy.base_proxy import MicroscopeServer, serialize

# from CEOSacquisition import CEOSacquisitionTCP # Not vending this for now to simplify

try:
    import autoscript_tem_microscope_client as auto_script
except ImportError:
    auto_script = None
    print("Warning: autoscript not found.")
